...
namespace HowlOut
{
	public partial class NewVoteView : ContentView, ViewModelInterface
	{
		public void reloadView() {
			this.Content = new NewVoteView(conversation);
		}
		...
		public NewVoteView(Conversation conv)
		{
			InitializeComponent();
			conversation = conv;
			...
			for (int i = 0; i < conv.subTypeDictionary["ToDoList"].Count; i++)
			{
				...
				profilePicker.Add(new CustomPicker() { Title = "None" });
				...
				statusPicker.Add(new CustomPicker() { Title = "Awaiting" });
